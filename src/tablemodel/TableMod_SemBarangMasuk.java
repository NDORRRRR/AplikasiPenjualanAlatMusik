...
public class TableMod_SemBarangMasuk extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {      
        switch (columnIndex){
          ...
          case 0: return list.get(rowIndex).getMo_bar().getKode_Barang();
          case 1: return list.get(rowIndex).getMo_bar().getNama_barang();
          case 2: return list.get(rowIndex).getMo_bar().getHarga();
          case 3: return list.get(rowIndex).getMod_detmasuk().getJml_masuk();
          case 4: return list.get(rowIndex).getMod_detmasuk().getSubtotalmasuk();
