...
public class MasterJenisBarang extends javax.swing.JPanel {
    ...
    private void dataTabel() {
        ...
        t_kodejenisbarang.setText   (tabel_barang.getModel().getValueAt(row, 0).toString());
        t_namajenisbarang.setText   (tabel_barang.getModel().getValueAt(row, 1).toString());
    ...
    private void hapusData() {
       ...
       if (index!=-1) {
           Model_jenis_barang brg = tblModel.getData(tabel_barang.convertRowIndexToModel(index));
    ...
    private void tampilPanel() {
        mainPanel.removeAll();
        mainPanel.add(new MasterJenisBarang());
        mainPanel.repaint();
        mainPanel.revalidate();
    }
    ...
    private void aktif() {
        t_kodejenisbarang.setVisible(true);
        t_namajenisbarang.setVisible(true);
    }
    ...
    private void simpanData() {
         ...
         if(servis.valisasiNamaJenisBarang(jb)==true) {
            ...
            Model_jenis_barang jbg = new Model_jenis_barang();
            jbg.setKode_jenis(kode_jenis);
            jbg.setNama_jenis(kode_jenis);
    ...
    private void perbaruiData() {
        ...
        int index = tabel_barang.getSelectedRow();
        if (index != -1) {
        Model_jenis_barang mobar = tblModel.getData(tabel_barang.convertRowIndexToModel(index));

        if(servis.valisasiNamaJenisBarang(mobar)==true) {
    ...
    private void pencarian() {
        List<Model_jenis_barang> list = servis.pencarian(t_cari.getText());
        tblModel.setData(list);
    }
}
